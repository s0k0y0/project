...
<body>
	...
	<div class="lolo">
		...
		<h2 class="text-muted" style="text-align: center;">게시물 수정</h2>
		<form action="/update?no=<%=게시물내용.getNo()%>" method="post">
			<input type="hidden" name="no" id="no" value="<%=게시물내용.getNo()%>">

			<div class="form-group">
				<label for="title" class="col-sm-2 control-label">제목</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="title" name="title"
						value="<%=게시물내용.getTitle()%>" required="required" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="writer"
						name="writerName" readonly="readonly"
						value="<%=게시물내용.getWriterName()%>" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="contents" name="contents"
						rows="9" style="height: 500px; width: 100%;"><%=게시물내용.getContents()%></textarea>
				</div>
			</div>
