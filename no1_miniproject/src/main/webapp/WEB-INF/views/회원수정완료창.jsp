...
<body>
	...
	<div class="topnav">
		<span><a class="nav-link" href="/join">회원가입 </a></span> <span><a
			class="nav-link" href="main.jsp">로그인</a></span>
	</div>
	...
	<div class="lolo">
		...
		<br>
		<button class="btn btn-secondary" onclick="location.href='/board'">Home</button>
	</div>
